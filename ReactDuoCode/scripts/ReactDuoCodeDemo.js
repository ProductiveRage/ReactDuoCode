...
var $asm = {
    ...
    types: [],
    $getAttrs: function() {
        return [new System.Reflection.AssemblyTitleAttribute.ctor("ReactDuoCodeDemo"), new System.Reflection.AssemblyDescriptionAttribute.ctor(""), 
            new System.Reflection.AssemblyConfigurationAttribute.ctor(""), new System.Reflection.AssemblyCompanyAttribute.ctor(""), 
            new System.Reflection.AssemblyProductAttribute.ctor("ReactDuoCodeDemo"), new System.Reflection.AssemblyCopyrightAttribute.ctor("Copyright \xA9  2015"), 
...
ReactDuoCodeDemo.Dispatcher.IDispatcherAction = $d.declare("ReactDuoCodeDemo.Dispatcher.IDispatcherAction", 
    null, 66, $asm, function($t, $p) {});
ReactDuoCodeDemo.Actions.TimePassedAction = $d.declare("ReactDuoCodeDemo.Actions.TimePassedAction", System.Object, 
    0, $asm, function($t, $p) {
...
ReactDuoCodeDemo.Actions.RecordChangeAction$1 = $d.declare("ReactDuoCodeDemo.Actions.RecordChangeAction`1", 
    System.Object, 256, $asm, function($t, $p, T) {
        $t.$intfs = [ReactDuoCodeDemo.Dispatcher.IDispatcherAction];
        $t.$ator = function() {
            this.$Value$k__BackingField = $d.default(T);
        };
        ...
        $t.ctor.prototype = $p;
        $p.get_Value = function RecordChangeAction$1_get_Value() { return this.$Value$k__BackingField; };
        $p.set_Value = function RecordChangeAction$1_set_Value(value) { this.$Value$k__BackingField = value;return value; };
    }, ["T"]);
ReactDuoCodeDemo.Dispatcher.AppDispatcher = $d.declare("ReactDuoCodeDemo.Dispatcher.AppDispatcher", System.Object, 
    0, $asm, function($t, $p) {
        $t.$ator = function() {
            $t.$_dispatcher$k__BackingField = null;
        };
        ...
        $p.add__dispatcher = function AppDispatcher_add__dispatcher(value) {
            this.$_dispatcher$k__BackingField = System.Delegate.Combine(this.$_dispatcher$k__BackingField, 
                value);
        };
        $p.remove__dispatcher = function AppDispatcher_remove__dispatcher(value) {
            this.$_dispatcher$k__BackingField = System.Delegate.Remove(this.$_dispatcher$k__BackingField, 
                value);
        };
        ...
        $p.HandleViewAction = function AppDispatcher_HandleViewAction(action) {
            ...
            this.$_dispatcher$k__BackingField(null, new ReactDuoCodeDemo.Dispatcher.DispatcherMessage.ctor(1 /* MessageSourceOptions.View */, 
                action));
        };
        $p.HandleServerAction = function AppDispatcher_HandleServerAction(action) {
            ...
            this.$_dispatcher$k__BackingField(null, new ReactDuoCodeDemo.Dispatcher.DispatcherMessage.ctor(0 /* MessageSourceOptions.Server */, 
                action));
        };
    });
ReactDuoCodeDemo.Dispatcher.DispatcherMessage = $d.declare("ReactDuoCodeDemo.Dispatcher.DispatcherMessage", 
    System.Object, 0, $asm, function($t, $p) {
        $t.$ator = function() {
            this.$Source$k__BackingField = 0 /* MessageSourceOptions */;
            this.$Action$k__BackingField = null;
        };
        ...
        $t.ctor.prototype = $p;
        $p.get_Source = function DispatcherMessage_get_Source() { return this.$Source$k__BackingField; };
        $p.set_Source = function DispatcherMessage_set_Source(value) { this.$Source$k__BackingField = value;return value; };
        $p.get_Action = function DispatcherMessage_get_Action() { return this.$Action$k__BackingField; };
        $p.set_Action = function DispatcherMessage_set_Action(value) { this.$Action$k__BackingField = value;return value; };
    });
ReactDuoCodeDemo.Dispatcher.MessageSourceOptions = $d.declareEnum("ReactDuoCodeDemo.Dispatcher.MessageSourceOptions", 
    45, $asm, 257, ["Server", "View"], [0, 1]);
...
ReactDuoCodeDemo.ReactBindings.Ele = $d.declare("ReactDuoCodeDemo.ReactBindings.Ele", System.Object, 
    0, $asm, function($t, $p) {
...
ReactDuoCodeDemo.ReactBindings.Ele.ElementFactory$1 = $d.declare("ElementFactory`1", System.Object, 256, 
    ReactDuoCodeDemo.ReactBindings.Ele, function($t, $p, TProps) {
        $t.$ator = function() {
...
ReactDuoCodeDemo.ReactBindings.Attributes.HTMLAttributes = $d.declare("ReactDuoCodeDemo.ReactBindings.Attributes.HTMLAttributes", 
    System.Object, 0, $asm, function($t, $p) {
        $t.$ator = function() {
            this.className = null;
        };
...
ReactDuoCodeDemo.ReactBindings.Attributes.InputAttributes = $d.declare("ReactDuoCodeDemo.ReactBindings.Attributes.InputAttributes", 
    ReactDuoCodeDemo.ReactBindings.Attributes.HTMLAttributes, 0, $asm, function($t, $p) {
        $t.$ator = function() {
            this.onChange = null;
            this.value = null;
        };
...
ReactDuoCodeDemo.Components.TestComponentProps = $d.declare("ReactDuoCodeDemo.Components.TestComponentProps", 
    System.Object, 0, $asm, function($t, $p) {
        $t.$ator = function() {
        ...
        $t.ctor.prototype = $p;
        $p.get_Name = function TestComponentProps_get_Name() { return this.$Name$k__BackingField; };
        $p.set_Name = function TestComponentProps_set_Name(value) { this.$Name$k__BackingField = value;return value; };
    });
ReactDuoCodeDemo.Components.TestComponent = $d.declare("ReactDuoCodeDemo.Components.TestComponent", ReactDuoCodeDemo.ReactComponentWrapper, 
    0, $asm, function($t, $p) {
        $t.New = function TestComponent_New(props) {
            return ReactDuoCodeDemo.ReactBindings.Ele.Props(ReactDuoCodeDemo.Components.TestComponentProps, 
                props).As(ReactDuoCodeDemo.Components.TestComponent);
        };
...
ReactDuoCodeDemo.Stores.SimpleExampleStore = $d.declare("ReactDuoCodeDemo.Stores.SimpleExampleStore", 
    System.Object, 0, $asm, function($t, $p) {
        $t.$ator = function() {
...
ReactDuoCodeDemo.Stores.SimpleExampleStore.ViewModel = $d.declare("ViewModel", System.Object, 0, ReactDuoCodeDemo.Stores.SimpleExampleStore, 
    function($t, $p) {
        $t.$ator = function() {
            this.$LastUpdated$k__BackingField = null;
            this.$Message$k__BackingField = null;
            this.$ValidationError$k__BackingField = null;
        };
        $t.ctor = function ViewModel(lastUpdated, message, validationError) {
            ...
            this.set_LastUpdated(ReactDuoCodeDemo.Stores.SimpleExampleStore.ViewModel.GetTimeString(lastUpdated));
            this.set_Message(message);
            this.set_ValidationError(validationError);
        };
        $t.ctor.prototype = $p;
        $p.get_LastUpdated = function ViewModel_get_LastUpdated() { return this.$LastUpdated$k__BackingField; };
        $p.set_LastUpdated = function ViewModel_set_LastUpdated(value) { this.$LastUpdated$k__BackingField = value;return value; };
        $p.get_Message = function ViewModel_get_Message() { return this.$Message$k__BackingField; };
        $p.set_Message = function ViewModel_set_Message(value) { this.$Message$k__BackingField = value;return value; };
        $p.get_ValidationError = function ViewModel_get_ValidationError() { return this.$ValidationError$k__BackingField; };
        $p.set_ValidationError = function ViewModel_set_ValidationError(value) { this.$ValidationError$k__BackingField = value;return value; };
